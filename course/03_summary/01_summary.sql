...
SELECT CompanyName, Country, City FROM Customer ORDER BY 2, 3 DESC;
...
SELECT ProductName, UnitPrice FROM Product ORDER BY 2 LIMIT 5;
-- Wyświetl 10 najdroższych produktów (UnitPrice) z tabeli Product.
SELECT ProductName, UnitPrice FROM Product ORDER BY 2 DESC LIMIT 10;
